...
public final class TerrainDynamic
{
	...
	public interface Resources extends Shader.DefaultResources
	{
		...
		@Source("terrain_dynamic_noise.fs")
		TextResource getFragmentShader();
		
		@Source("terrain_dynamic_noise.vs")
	 ...
	 */
	class DemoScene extends AnimatedScene implements Texture.ImageLoadHandler, HasEventBus, ViewportResizeHandler
	{
